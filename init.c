...
int init_global(void)
{
  ...
  DTdumpgen[DTFLUX]=DTdumpgen[DTOTHER]=DTdumpgen[DTEOS]=DTdumpgen[DTVPOT]=DTdumpgen[DTDUMP] = 25.;			/* dumping frequency, in units of M */
