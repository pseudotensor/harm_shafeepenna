...
static void ucon_calc_g(FTYPE prim[MYNPRINVERT],FTYPE gcov[NDIM][NDIM],FTYPE gcon[NDIM][NDIM],FTYPE ucon[NDIM]) ;
...
static void primtoU_g( FTYPE prim[MYNPRINVERT], FTYPE gcov[NDIM][NDIM], FTYPE gcon[NDIM][NDIM],FTYPE U[MYNPRINVERT] );
